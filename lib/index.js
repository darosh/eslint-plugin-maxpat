...
const plugin = {
  meta: {
    name: 'eslint-plugin-maxpat', version: '1.0.0',
  }, rules: {
...
Object.assign(plugin.configs, {
  recommended: {
    files: ['*.maxpat'], plugins: { maxpat: plugin }, languageOptions: {
      parser: jsonc,
    }, rules: {
      ...
      // 'list-ui-elements': ['info', ['slider', 'dial', 'button', 'toggle', 'number', 'live.dial', 'live.slider', 'live.button', 'live.toggle', 'live.menu', 'live.tab',]],
