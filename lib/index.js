...
Object.assign(plugin.configs, {
  recommended: {
    ...
    rules: {
      ...
      // LAYOUT
      'maxpat/layout/snap-to-grid': ['warn'],
      'maxpat/layout/snap-to-pixel': ['warn', true],
      'maxpat/layout/grid-size': ['warn', [8, 8]],
      ...
      'maxpat/flow/disconnected': ['warn', [
        'comment', 'panel', 'fpic', 'bpatcher', 'live.comment', 'live.banks'
      ],],
      ...
      // DEBUG
      'maxpat/debug/connected-print': 'warn',
      
      // COMPATIBILITY
      'maxpat/compatibility/check-deprecated-objects': ['warn', [
      ...
      'maxpat/performance/speed-limit': ['warn', 10, [
        'slider', 'dial', 'button', 'toggle', 'number', 'live.dial', 
        'live.slider', 'live.button', 'live.toggle', 'live.text', 
        'live.menu', 'live.tab',
      ]],
