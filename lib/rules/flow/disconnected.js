export default {
  meta: {
    type: 'problem',
    docs: {
      description: 'No disconnected objects',
    ...
    schema: [
      {
        ...
        properties: {
          exclude: {
            ...
            items: { type: 'string' },
            uniqueItems: true,
            default: ['comment', 'panel', 'fpic', 'bpatcher', 'live.comment', 'live.banks'],
            description: 'Excluded objects'
          }
        },
    ...
    defaultOptions: [{
      exclude: ['comment', 'panel', 'fpic', 'bpatcher', 'live.comment', 'live.banks']
    }],
    messages: {
