// lib/rules/check-local-send-receive.js
export default {
  meta: {
    type: 'problem',
    docs: {
  ...
  create (context) {
    return {
      // Look for the patcher object to collect send/receive objects
      JSONProperty (node) {
        ...
        // Collect send and receive objects with triple dash prefixes
